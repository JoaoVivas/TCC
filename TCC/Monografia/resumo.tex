...
sistema.
% 
A metodologia envolve o uso do \textit{software} Matlab e a função
fmincon para a geração de comandos.
% 
...
Dificuldades como a função objetivo, restrições não lineares da base
e variáveis principais são discutidas.
