...
\begin{figure}[!htb]
    \centering
    \caption{teste}
    \includegraphics[scale=0.5]{ringing-test}
...
\begin{figure}[!htb]
    \centering
    \caption{teste}
    \includegraphics[scale=0.4]{lookaheadboth2}
...
\begin{figure}[!htb]
    \centering
    \caption{teste}
    \includegraphics[scale=0.4]{lookaheaddir1}
    \includegraphics[scale=0.4]{lookaheadtrap1}
...
\begin{figure}[!htb]
    \centering
    \caption{teste}
    \includegraphics[scale=0.5]{trapezoidex}
