...
\subsection{Integração utilizando programação não linear}

Descreve um algoritmo para a solução numérica direta de problemas de controle ótimo \cite{hargraves87}. 
